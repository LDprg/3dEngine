/*****************************************************************/ /**
 * \file   DynamicDrawableSystem.cpp
 * \brief  DynamicDrawableSystem Source
 * 
 * \author LD
 * \date   March 2023
 *********************************************************************/
#include "DynamicDrawableSystem.hpp"

#include <Engine/Core/Application.hpp>

using namespace __XXECS::Entity;

auto DynamicDrawableSystem::Create(const entt::entity &entity) -> void
{
...
auto DynamicDrawableSystem::Run(const entt::entity &entity) -> void
{
    auto &target = GetEntityManager().get<Drawable>(entity);
